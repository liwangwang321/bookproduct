...
<!--end nav-->
	...
	<div class="w960">
		<div class="side left">
			...
			<h4>书籍管理</h4>   
	      	<ul class="classify E6">
		      	...
		      	<li>&nbsp;&nbsp;<a href="listBook3.jsp"  style="font-size: 15px;color: red">已下架</a></li>
		      	<div class="fixed"></div>
			</ul>
			<h4>订单管理</h4>        
		    <ul class="classify E6">
		...
		<div class="w740 right">
	        ...
	        <div class="order01">
	        	<form name="" method="post" action="bookAction.action?methodName=listBook&book_state=3">
	        	...
	        	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
	        	 ...
	        	 <c:if test="${empty listBookset }">
				 	<jsp:forward page="bookAction.action?methodName=listBook&book_state=3" />
				 </c:if>
	              ...
	              <c:forEach items="${listBook }" var="g">
	              	 <tr>
		                ...
		                <td width="15%" class="text">
		                	...
		                	<a href="bookAction.action?methodName=delbook&book_id=${g.book_id }&type=2"  onclick="return confirm('你是否要删除？')==1">删除</a>
		                	<a href="bookAction.action?methodName=editstate2&book_id=${g.book_id }">上架</a>
