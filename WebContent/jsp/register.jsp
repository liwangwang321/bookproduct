...
<input type="hidden" id="sd" value="${Reser }" />
...
<!--end nav-->
	...
	<div class="logoin_wrap mt30">
		<h2>用户注册</h2>
		<div id="table">
			<form action="userAction.action?methodName=register" method="post">
			...
			<table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="56%" align="left" valign="middle">
						<input type="text" name="name" value="" id="" class="input w180">
					</td>
				</tr>
			</table>
			<table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="56%" align="left" valign="middle">
						<input type="password" name="pwd" value="" id="" class="input w180">
					</td>
				</tr>
			</table>
