	...
	<div class="w960">
		<div class="side left">
			...
			<h4>书籍管理</h4>   
	      	<ul class="classify E6">
		      	<li>&nbsp;&nbsp;<a href="addBook.jsp"  style="font-size: 15px;color: red">新&nbsp;&nbsp;增</a></li>
		...
		<div class="w740 right">
	        ...
	        <div class="order02 pb10">
	        	<form name="bookForm" method="post" action="bookAction.action?methodName=addbook">
	        	<table width="738" align="center" cellpadding="0" cellspacing="0">
	        		<tr class="bd2">
	        			...
	        			<td width="80%"  align="left" class="bd1 pl9" >
	        				<input type="text" name="book_name" value="" id="book_name" class="input w300">
	        			</td>
	        		</tr>
	        		<tr class="bd2">
	        			...
	        			<td width="80%"  align="left" class="bd1 pl9">
	        				...
	        				<z:select textVal="book_category_name" items="${book_category }" name="book_category_id" textKey="book_category_id"></z:select>
	        		...
	        		<tr class="bd2">
	        			...
	        			<td width="80%"  align="left" class="bd1 pl9" >
	        				<input type="text" name="book_author" value="" id="book_author" class="input w300">
	        			</td>
	        		</tr>
	        		<tr class="bd2">
	        			<th width="20%" align="center" class="bd2">价格</td>
	        			<td width="80%"  align="left" class="bd1 pl9" >
	        				<input type="text" name="book_price" value="" id="book_price" class="input w300">
	        			</td>
	        		</tr>
	        		<tr class="bd2">
	        			<th width="20%" align="center" class="bd2">出版社</td>
	        			<td width="80%"  align="left" class="bd1 pl9" >
	        				<input type="text" name="publishing" value="" id="publishing" class="input w300">
	        			</td>
	        		</tr>
	        		<tr class="bd2">
	        			<th width="20%" align="center" class="bd2">简介</td>
	        			<td width="80%"  align="left" class="bd1 pl9" rowspan="3">
	        				<textarea name="book_desc" rows="6" id="book_desc" class="w300"></textarea>
	        			</td>
	        		</tr>
	        		<tr class="">
