	...
	<div class="w960">
		<div class="side left">
		    ...
		    <ul class="classify E6">
		      	<li>&nbsp;&nbsp;<a href="listMyOrder1.jsp" style="font-size: 15px;color: red">未发货</a></li>
		...
		<div class="w740 right">
	        ...
	        <input type="hidden" id="user" value="${user }" />
			 <c:if test="${empty listmyorderset }">
			 	<jsp:forward page="orderAction.action?methodName=listMyorder&order_state=1&user_id=${user.user_id }" />
			 </c:if>
	        	...
	        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	              ...
	              <c:if test="${not empty listmyorder }">
		              ...
		              <tr>
		                ...
		                <td width="10%" class="text">
		                	<a href="orderAction.action?methodName=delorder&order_id=${g.order_id }">撤单</a>
		                </td>
		              </tr>
