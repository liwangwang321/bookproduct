...
<script type="text/javascript" src="${pageContext.request.contextPath }/static/js/shoppingCar.js"></script>
...
<!--end nav-->
	...
	<div class="w960 mt10">
		...
		<div class="w740 right">
			<div class="order02" id="tb">
	        	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="tab">
	            
	              
	            </table>
	            
	            <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="bd2" id="tabs">
            	...
            	<table width="738" border="0" cellspacing="0" cellpadding="0" class="mt10">
            		<tr>
            			...
            			<td width="30%" align="center" >
            				<a href="bookAction.action?methodName=shopexit"><img src="images/btn_shoppingcart.png"/></a>
           				</td>
           				<td width="30%" align="center" >
           					<a href="findBook.jsp"><img src="images/btn_jxgm.png"/></a>
          				</td>
          				<td width="30%" align="center" >
          					<a href="addOrder.jsp?shoptype=2"><img src="images/btn_accounts.png"/></a>
          				</td>
          				<td width="5%"></td>
         			</tr>
         		</table>
